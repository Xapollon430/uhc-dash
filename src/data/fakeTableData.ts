...
export const tableData = [
  ...
  // RVUs (Blue)
  {
    ...
    type: "data",
    label: "Work RVUs",
    values: [624.1, 525.96, 168.82, 219.76, 312.45, 489.22, 517.33, 455.12, 388.76, 412.88, 397.23, 579.67],
    total: 4997.1,
    coding: "98%",
    colorGroup: "blue",
  ...
  },
  {
    ...
    values: [1.88, 2.13, 1.76, 1.8, 2.71, 2.78, 1.95, 2.12, 2.74, 1.99, 2.11, 2.15],
    total: 2.71,
    coding: "97%",
    colorGroup: "blue",
  },
  ...
  // Charges (Yellow/Green)
  {
    ...
    type: "data",
    label: "Charges",
    values: [57445, 44479.5, 41179, 27677, 25477, 33217, 29177, 31757, 35887, 29977, 26577, 35577],
    total: 397313,
    coding: "177%",
    colorGroup: "yellow",
    isCurrency: true,
  ...
  },
  {
    ...
    values: [173.73, 181.36, 122.81, 169.43, 155.22, 167.12, 148.99, 177.34, 162.45, 158.77, 166.11, 174.97],
    total: 171.33,
    coding: "98%",
    colorGroup: "yellow",
    isCurrency: true,
  ...
  // Payments (Green)
  {
    ...
    type: "data",
    label: "Payments",
    values: [38689, 19638, 16153, 15777, 17277, 27177, 18977, 21757, 27577, 19877, 18477, 22777],
    total: 239437,
    coding: "63%",
    colorGroup: "green",
    isCurrency: true,
  ...
  // Adjustments (Pink)
  {
    ...
    type: "data",
    label: "Adjustments",
    values: [42685, 18277, 12933, 17323, 11577, 13477, 12977, 12757, 11877, 12177, 11977, 12777],
    total: 189561,
    coding: "65%",
    colorGroup: "pink",
    isCurrency: true,
  ...
  // Provider Income (Orange)
  {
    ...
    values: ["$12,577", "$13,277", "$14,777", "$12,977", "$13,877", "$14,577", "$13,677", "$14,277", "$13,977", "$14,377", "$13,777", "$14,177"],
    total: "$164,677",
    coding: "",
    colorGroup: "orange",
    isCurrency: true,
  ...
  },
  {
    ...
    type: "data",
    label: "% of Payments",
    values: ["48%", "52%", "57%", "53%", "49%", "51%", "52%", "57%", "48%", "53%", "49%", "51%"],
    total: "51%",
    coding: "",
    colorGroup: "orange",
  },
